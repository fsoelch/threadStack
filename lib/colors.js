...
function normalizeInlineColorsInHtml(html) {
  ...
  //    Bei nicht normalisierbarer Farbe: Oeffnungstag entfernen.
  ...
  // Jedes verbleibende </font> konsistent auf </span> mappen, da jedes
  // ersetzte <font> entweder zu <span> wurde oder ganz entfernt wurde -
  // in letzterem Fall bleibt ein harmloses zusaetzliches </span> uebrig,
  // das von nachgelagertem Allowlist-Sanitizing entfernt wird.
